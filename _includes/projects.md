...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="links">
      ...
      <div class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Open Source</div>
      <strong><i style="color:#e74d3c">185 GitHub Stars</i></strong>
    </div>
  </div>
</div>
</li>
